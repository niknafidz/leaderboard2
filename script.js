...
function updateLeaderboard() {
    fetch('scanned_data_log.csv')
        ...
        .then(data => {
            ...
            leaderboardBody.innerHTML = ''; // Clear the leaderboard content
...
// Initial update and subsequent updates every 10 seconds
updateLeaderboard();
setInterval(updateLeaderboard, 10000); // 10000 milliseconds = 10 seconds
